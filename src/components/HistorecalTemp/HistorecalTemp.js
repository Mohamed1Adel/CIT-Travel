  ...
  return (
    <Card className="hotel-card" >
      ...
      <Card.Body>
        ...
        {
              program?._id === "65d22e40825030440a589a13" ?  <h6 class="m-0 pb-3" style={{color:"#fc4c03",display:"block",zIndex:"999",position:"absolute",bottom:"20px",fontSize:"16px",margin:"0"}}>Starting from <br /> 610 $ </h6>: <h6 class="m-0 pb-3" style={{color:"#fc4c03",display:"block",zIndex:"999",position:"absolute",bottom:"20px",fontSize:"16px",margin:"0"}}>  </h6>
            }
        {
        ...
        {
              program?._id === "65d238902eb6764f97ff2114" ?  <h6 class="m-0 pb-3" style={{color:"#fc4c03",display:"block",zIndex:"999",position:"absolute",bottom:"20px",fontSize:"16px",margin:"0"}}>Starting from <br /> 650 $ </h6>: <h6 class="m-0 pb-3" style={{color:"#fc4c03",display:"block",zIndex:"999",position:"absolute",bottom:"20px",fontSize:"16px",margin:"0"}}>  </h6>
            }
        {
