  ...
  return (
    <Container>
      ...
      <p style={{width:"90%",margin:"0 auto",fontWeight:"500",fontSize:"20px",textAlign:"start"}}>
        ...
        highest class of tourist license in Egypt (Class A) License No. 2458 <br /> And
        Trade License no.100107 and Tax Card No. 340-497-122 and Member of IATA
        code No. 90257344 <br /> Our Company Established in 2012 under the name of
        ...
        Egyptian tourism market. <br /> We are proud to be a well-established and
        ...
        Umrah Holy packages . <br /> C.I.T Travel succeeded to provide a new vision for
        ...
        customers inside and outside Egypt during the previous Period. <br /> Our team
        ...
        us. <br /> We operate from Cairo and we know our country as you know the palm
        ...
        have been able to acquire trough this many years of operations. <br />
      </p>
        </div>
